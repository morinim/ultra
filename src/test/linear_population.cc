...
TEST_CASE("Concepts")
{
  ...
  CHECK(Population<linear_population<gp::individual>>);
  CHECK(!LayeredPopulation<linear_population<gp::individual>>);
  CHECK(RandomAccessIndividuals<linear_population<gp::individual>>);
  CHECK(SizedRandomAccessPopulation<linear_population<gp::individual>>);
}
